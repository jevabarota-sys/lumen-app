  ...
  Future<void> _verifyAndDeliverPurchase(
    ...
    if (Platform.isAndroid) {
      ...
      await prefs.setString(
          'purchase_token', androidDetails.billingClientPurchase.purchaseToken);
    } else if (Platform.isIOS) {
      final iosDetails = purchaseDetails as AppStorePurchaseDetails;
      await prefs.setString('transaction_id',
          iosDetails.skPaymentTransaction.transactionIdentifier ?? '');
    }
